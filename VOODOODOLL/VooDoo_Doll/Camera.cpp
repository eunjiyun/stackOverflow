...
void CThirdPersonCamera::Update(XMFLOAT3& camera_pos, XMFLOAT3& xmf3LookAt, float fTimeElapsed)
{
	if (m_pPlayer)
	{
		...
		XMFLOAT3 xmf3Direction = Vector3::Subtract(camera_pos, m_xmf3Position);
...
void CThirdPersonCamera::SetLookAt(XMFLOAT3& xmf3LookAt)
{
	if (m_lock)
	{
		m_xmf3Position = XMFLOAT3(800, -150, 700);  
		return; 
	}
