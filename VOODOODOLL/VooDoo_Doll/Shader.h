...
public:
	...
	virtual void BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList,int num, void* pContext = NULL);
	void BuildObjects2(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, int num, void* pContext = NULL);
	virtual void AnimateObjects(float fTimeElapsed);
	virtual void ReleaseObjects();
...
public:
	...
	void PrepareShadowMap(ID3D12GraphicsCommandList* pd3dCommandList,LIGHT*);
...
class CDepthRenderObjShader : public CIlluminatedShader
{
public:
	//CDepthRenderObjShader(){}

	CDepthRenderObjShader(CBoxShader* pObjectsShader, LIGHT* pLights);
	virtual ~CDepthRenderObjShader();
...
//class CShadowMapObjShader : public CIlluminatedShader
//{
//public:
//	CShadowMapObjShader(CBoxShader* pObjectsShader);
//	virtual ~CShadowMapObjShader();
//
//	virtual D3D12_DEPTH_STENCIL_DESC CreateDepthStencilState();
//
//	virtual D3D12_SHADER_BYTECODE CreateVertexShader();
